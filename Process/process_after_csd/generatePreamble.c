...
void generatePreamble(complex32* oneStreamOfSTF,
     ...
     //for test
     //generate Sig
     generateSig(basicSig,oneStreamOfSig,NTXindex);
     //free data
     free(basicSig);
}
